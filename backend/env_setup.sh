...
echo "=============================="
echo "   Setup Dev Environments     "
echo "=============================="

ENV_FILE_DEV="./.env/.env.development"
...
echo "=============================="
echo "    Setup Pro Environments    "
echo "=============================="

ENV_FILE_PRO="./.env/.env.production"

# Create the .env directory if it doesn't exist
mkdir -p "$(dirname "$ENV_FILE_PRO")"

# Write content to the .env file
cat <<EOF > "$ENV_FILE_PRO"
VITE_API_BACKEND_URL=https://dev-cms.10academy.org
VITE_API_CHATBOT_BACKEND_URL=https://nana.10academy.org
EOF

echo "Environment variables written to $ENV_FILE_PRO"
